...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" action="{{ route('edit.seo_advise', $seo_advise) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="seo_id" value="{{ $seo_advise->seo_id }}">
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control check-seo title-seo"
                                                    ...
                                                    value="{{ old('seo_tittle') ?? $seo_advise->seo->seo_tittle }}">
                                            </div>
                                            <div class="form-group">
                                                <div class="label-seo">
                                                ...
                                                <input type="text" class="form-control check-seo keywords-seo"
                                                    ...
                                                    value="{{ old('seo_ketword') ?? $seo_advise->seo->seo_keyword }}">
                                            </div>
                                            <div class="form-group">
                                                <div class="label-seo">
                                                ...
                                                <textarea class="form-control check-seo description-seo" name="seo_description" id="descriptionvi" rows="5"
                                                    placeholder="SEO Description (vi)">{{ old('seo_keyword') ?? $seo_advise->seo->seo_keyword }}</textarea>
                                            </div>
