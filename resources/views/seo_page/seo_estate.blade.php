...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" action="index.php?com=seopage&act=save&type=san-pham" enctype="multipart/form-data">
                            ...
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    <img class="rounded img-upload"
                                        src="../thumbs/300x200x1/upload/seopage/logo-5206-4320.png"
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control check-seo keywords-seo"
                                                    ...
                                                    value="nhà đất minh phát chuyên bán nhà phố, bán đất nền, mua bán đất giá rẻ, mua bán nhà phố, mua bán nhà phố hcm, bán nhà hcm, bán nhà phố giá rẻ, mua bán đất hcm, mua bán đất, ký gửi nhà đất, hoàn công,  tư vấn pháp lý.">
                                            </div>
                                            <div class="form-group">
                                                <div class="label-seo">
