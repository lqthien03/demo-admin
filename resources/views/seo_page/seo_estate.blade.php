...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" action="{{ route('edit.seo_estate', $seo_estate) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="seo_id" value="{{ $seo_estate->seo_id }}">
                            ...
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    <img class="rounded img-upload" id="uploaded-image"
                                        src="{{ URL::asset('products/' . $seo_estate->image) }}" alt="Alt Photo" />
                                    <strong>
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control check-seo description-seo" name="seo_description" id="descriptionvi" rows="5"
                                                    placeholder="SEO Description (vi)">{{ old('seo_keyword') ?? $seo_estate->seo->seo_keyword }}</textarea>
                                            </div>
