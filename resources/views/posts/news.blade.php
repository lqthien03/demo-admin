                        ...
                        <tbody>
                            @foreach ($news as $item)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="/posts/news/edit/{{ $item->id }}" title=""><img
                                    ...
                                    <td class="align-middle">
                                        <a class="text-dark" href="/posts/news/edit/{{ $item->id }}"
                                            title="">{{ $item->tittle }}</a>
                                        <div class="tool-action mt-2 w-clear">
                                            ...
                                            <a class="text-info mr-3" href="/posts/news/edit/{{ $item->id }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul aria-labelledby="dropdownCopy"
                                                    ...
                                                    <li><a href="#" class="dropdown-item copy-now"
                                                            ...
                                                            chép ngay</a></li>
                                                    <li><a href="/posts/news/edit/{{ $item->id }}"
                                                            class="dropdown-item"><i
                                                                class="far fa-caret-square-right text-secondary mr-2"></i>Chỉnh
                                                            sửa thông tin</a></li>
                                                </ul>
                                            </div>
                                            <form action="{{ route('delete.news', ['id' => $item->id]) }}"
                                                method="post">
                                                @csrf
                                                @method('PUT')
                                                <button
                                                    ...
                                                    <a class="text-danger" id="delete-item" data-url=""
                                                        title=""
                                                        href="/posts/news/delete/{{ $item->id }}"><i
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="custom-control custom-checkbox my-checkbox">
                                            <input type="checkbox" class="custom-control-input show-checkbox"
                                                ...
                                                data-loai="noibat" {{ $item->outstand == 1 ? 'checked' : '' }}>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="custom-control custom-checkbox my-checkbox">
                                            <input type="checkbox" class="custom-control-input show-checkbox"
                                                ...
                                                data-loai="hienthi"{{ $item->display == 1 ? 'checked' : '' }}>
                                    ...
                                    <td class="align-middle text-center text-md text-nowrap">
                                        <form action="{{ route('delete.news', ['id' => $item->id]) }}"
                                            ...
                                            <a class="text-primary mr-2" href="/posts/news/edit/{{ $item->id }}"
