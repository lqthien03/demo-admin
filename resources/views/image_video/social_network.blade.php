                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <input type="number" class="form-control form-control-mini m-auto update-stt"
                                            min="0" value="{{ $item->number }}" data-id="51"
                                            data-table="photo">
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="/image-video/social_network/edit/{{ $item->id }}"
                                    ...
                                    <form action="{{ route('delete.social_network', ['id' => $item->id]) }} "
                                        method="post">
                                        @csrf
                                        @method('DELETE')
                                        <td class="align-middle text-center text-md text-nowrap">
                                            <a class="text-primary mr-2"
                                                href="/image-video/social_network/edit/{{ $item->id }}"
