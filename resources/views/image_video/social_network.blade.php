        ...
        <section class="content">
            <div class="card-footer text-sm sticky-top">
                <a class="btn btn-sm bg-gradient-primary text-white"
                    href="index.php?com=photo&act=add_photo&type=mangxahoi&p=1" title="Thêm mới"><i
                        ...
                        <tbody>
                            <tr>
                                <td class="align-middle">
                                    <div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input select-checkbox"
                                            id="select-checkbox-51" value="51">
                                ...
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-stt"
                                        min="0" value="1" data-id="51" data-table="photo">
                                </td>
                                <td class="align-middle text-center">
                                    <a href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=51"
                                        title=""><img class="rounded img-preview"
                                            onerror="src='assets/images/noimage.png'"
                                            src="../thumbs/30x30x1/upload/photo/mxh1-1-1957.png" alt=""></a>
                                </td>
                                <td class="align-middle">https://www.google.com/</td>
                                <td class="align-middle text-center">
                                    <div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox"
                                            id="show-checkbox-51" data-table="photo" data-id="51"
                                ...
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="text-primary mr-2"
                                        href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=51"
                                        title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
                                    <a class="text-danger" id="delete-item"
                                        data-url="index.php?com=photo&act=delete_photo&type=mangxahoi&p=1&id=51"
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input select-checkbox"
                                            id="select-checkbox-52" value="52">
                                        <label for="select-checkbox-52" class="custom-control-label"></label>
                                    </div>
                                </td>
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-stt"
                                        min="0" value="2" data-id="52" data-table="photo">
                                </td>
                                <td class="align-middle text-center">
                                    <a href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=52"
                                        title=""><img class="rounded img-preview"
                                            onerror="src='assets/images/noimage.png'"
                                            src="../thumbs/30x30x1/upload/photo/mxh1-2-1178.png" alt=""></a>
                                </td>
                                <td class="align-middle">https://www.google.com/</td>
                                <td class="align-middle text-center">
                                    <div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox"
                                            id="show-checkbox-52" data-table="photo" data-id="52"
                                            data-loai="hienthi" checked>
                                        <label for="show-checkbox-52" class="custom-control-label"></label>
                                    </div>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="text-primary mr-2"
                                        href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=52"
                                        title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
                                    <a class="text-danger" id="delete-item"
                                        data-url="index.php?com=photo&act=delete_photo&type=mangxahoi&p=1&id=52"
                                        title="Xóa"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="align-middle">
                                    <div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input select-checkbox"
                                            id="select-checkbox-53" value="53">
                                        <label for="select-checkbox-53" class="custom-control-label"></label>
                                    </div>
                                </td>
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-stt"
                                        min="0" value="3" data-id="53" data-table="photo">
                                </td>
                                <td class="align-middle text-center">
                                    <a href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=53"
                                        title=""><img class="rounded img-preview"
                                            onerror="src='assets/images/noimage.png'"
                                            src="../thumbs/30x30x1/upload/photo/mxh1-3-4655.png" alt=""></a>
                                </td>
                                <td class="align-middle">https://www.google.com/</td>
                                <td class="align-middle text-center">
                                    <div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox"
                                            id="show-checkbox-53" data-table="photo" data-id="53"
                                            data-loai="hienthi" checked>
                                        <label for="show-checkbox-53" class="custom-control-label"></label>
                                    </div>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="text-primary mr-2"
                                        href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=53"
                                        title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
                                    <a class="text-danger" id="delete-item"
                                        data-url="index.php?com=photo&act=delete_photo&type=mangxahoi&p=1&id=53"
                                        title="Xóa"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-stt"
                                        min="0" value="4" data-id="54" data-table="photo">
                                </td>
                                <td class="align-middle text-center">
                                    <a href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=54"
                                        title=""><img class="rounded img-preview"
                                            onerror="src='assets/images/noimage.png'"
                                            src="../thumbs/30x30x1/upload/photo/mxh1-4-6766.png" alt=""></a>
                                </td>
                                <td class="align-middle">https://www.google.com/</td>
                                <td class="align-middle text-center">
                                    <div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox"
                                            id="show-checkbox-54" data-table="photo" data-id="54"
                                            data-loai="hienthi" checked>
                                        <label for="show-checkbox-54" class="custom-control-label"></label>
                                    </div>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="text-primary mr-2"
                                        href="index.php?com=photo&act=edit_photo&type=mangxahoi&p=1&id=54"
                                        title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
                                    <a class="text-danger" id="delete-item"
                                        data-url="index.php?com=photo&act=delete_photo&type=mangxahoi&p=1&id=54"
                                        title="Xóa"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        </tbody>
