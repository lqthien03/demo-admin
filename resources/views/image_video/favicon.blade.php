...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" id="form-watermark" action="index.php?com=photo&act=save_static&type=favicon"
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    <img class="rounded img-upload"
                                        src="../thumbs/48x48x1/upload/photo/logo-9090-9915.png"
                            ...
                            <strong class="d-block mt-2 mb-2 text-sm">Width: 48 px - Height: 48 px
